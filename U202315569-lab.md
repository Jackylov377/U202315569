...
<div style="display: flex; justify-content: center; align-items: flex-start; gap: 30px;">
  <figure style="text-align: center;">
    <img src="images/并发数和延迟的关系.png" alt="图8" width="400">
    <figcaption>图8 并发数和延迟的关系</figcaption>
  </figure>
  <figure style="text-align: center;">
    <img src="images/并发数和吞吐率的关系.png" alt="图9" width="400">
    <figcaption>图9 并发数和吞吐率的关系</figcaption>
  </figure>
</div>
